...
public class Lab45_Selenium_Exceptions_StaleElement_Fix_it {
    ...
    public void test_selenium_exceptions() {
        ...
        try {
            ...
            WebElement search_input_box1  = driver.findElement(By.xpath("//textarea[@id='APjFqb']"));        System.out.println(driver.getWindowHandle());
